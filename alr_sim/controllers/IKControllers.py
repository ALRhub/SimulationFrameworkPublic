...
import alr_sim.controllers.GainsInterface as gains
import alr_sim.utils as alr_utils
from alr_sim.controllers.Controller import TrackingController
...
class CartPosQuatImpedenceController(
    ...
    def getControl(self, robot):
        ...
        for i in range(self.num_iter):
            ...
            target_cquat = alr_utils.get_quaternion_error(curr_quat, des_quat)
        ...
        if np.sum(np.abs(self.desired_c_pos - current_c_pos)) > 0.1:
            target_cquat = alr_utils.get_quaternion_error(curr_quat, self.desired_quat)
...
class CartPosQuatImpedenceJacTransposeController(
    ...
    def getControl(self, robot):
        ...
        target_cquat = self.pgain_quat * alr_utils.get_quaternion_error(
