...
from alr_sim.controllers import (
...
from alr_sim.controllers.IKControllers import CartPosQuatCartesianRobotController
from alr_sim.core import RobotBase, RobotControlInterface
from alr_sim.sims.mujoco.mj_utils.mujoco_helpers import reset_mocap2body_xpos
from alr_sim.sims.mujoco.MujocoCamera import MjInhandCamera
from alr_sim.sims.mujoco.MujocoLoadable import MujocoIncludeTemplate
...
class MujocoRobot(RobotBase, MujocoIncludeTemplate):
    ...
    def __init__(
        ...
        super(MujocoRobot, self).__init__(
            scene, dt, num_DoF, base_position, base_orientation
        )
        ...
        if xml_path is None:
            xml_path = sim_framework_path("./models/mujoco/robots/panda.xml")
