...
from alr_sim.core.sim_object import IntelligentSimObject, SimObject
from alr_sim.sims.pybullet.PybulletCamera import PbCageCam
from alr_sim.sims.pybullet.PybulletLoadable import PybulletLoadable
from alr_sim.utils.geometric_transformation import wxyz_to_xyzw, xyzw_to_wxyz
...
class PyBulletScene(Scene):
    ...
    def _setup_scene(self):
        # load surroundings
        p.loadURDF(
            sim_framework_path("./models/pybullet/objects/plane/kit_plane.urdf"),
        ...
        p.loadURDF(
            sim_framework_path(
                "./models/pybullet/surroundings/kit_lab_surrounding.urdf"
            ),
