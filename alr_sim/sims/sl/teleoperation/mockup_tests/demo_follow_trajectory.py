...
from alr_sim.sims.sl.teleoperation.demo_teacher import connect_sl_robot
from alr_sim.sims.sl.teleoperation.mockup_tests.follow_trajectory.trajectory_controller import (
    TrajectoryController,
)
from alr_sim.sims.sl.teleoperation.mockup_tests.follow_trajectory.trajectory_robot import (
    TrajectoryMockupRobot,
)
from alr_sim.sims.sl.teleoperation.mockup_tests.follow_trajectory.trajectory_scheduler import (
    MetaTrajectoryScheduler,
)
from alr_sim.sims.sl.teleoperation.src.controller import teleop_controller as tele_ctrl
from alr_sim.sims.sl.teleoperation.src.ui.cli_prompts import TrajectoryCliMap
from alr_sim.sims.sl.teleoperation.src.util.teaching_log import TeleopMetaLogger
