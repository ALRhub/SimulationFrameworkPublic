...
class RobotLogger(LoggerBase):
    ...
    def log_dict(self):
        ...
        log_dict.update({"time_stamp": self.robot.time_stamp})
        return log_dict
    ...
    def _start(
        ...
        **kwargs
        ...
        if log_interval is None:
            self.log_interval = self.robot.dt
        else:
            self.log_interval = log_interval

        assert self.log_interval >= self.robot.dt
        ...
        self.initial_time_stamp = self.robot.time_stamp
    ...
    def _log(self):
        ...
        self.last_log_time = log_properties["time_stamp"]
...
class ObjectLogger(LoggerBase):
    ...
    def __init__(self, scene, sim_object):
        super().__init__()
        """
        Initialization of the quantities to log.
        """
    ...
    def log_dict(self):
        ...
        log_dict.update({"time_stamp": self.scene.time_stamp})
    ...
    def _start(
        ...
        **kwargs
        ...
        self.initial_time_stamp = self.scene.time_stamp
    ...
    def _check_log_interval(self) -> bool:
        if (
            self.last_log_time is None
            or self.scene.time_stamp >= self.last_log_time + self.log_interval
        ):
            return True
        return False
