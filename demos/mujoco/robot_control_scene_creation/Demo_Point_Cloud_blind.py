...
if __name__ == "__main__":
    ...
    # Demo can be removed? Same as Demo_Point_Cloud
    ...
    scene = sim_factory.create_scene(
        object_list=object_list, render=sim_factory.RenderMode.BLIND
    )
    ...
    points_cage, colors_cage = scene.get_cage_cam().calc_point_cloud()
