...
if __name__ == '__main__':
    ...
    scene = Scene(object_list=object_list, dt=0.001)

    PyBulletRobot = PyBulletRobot(p, scene, pos_ctrl=True, gravity_comp=True)
    ...
    print('now pos 1, position get_error:', PyBulletRobot.get_pos_error(desired_cart_pos_1))
    print('now pos 1, orientation get_error:', PyBulletRobot.get_orientation_error(desired_quat_1))
    ...
    PyBulletRobot.set_gripper_width = 0.04
    print('now pos 2, position get_error:', PyBulletRobot.get_pos_error(desired_cart_pos_2))
    print('now pos 2, orientation get_error:', PyBulletRobot.get_orientation_error(desired_quat_2))
    #
    ...
    PyBulletRobot.set_gripper_width = 0.0
    print('now pos 3, position get_error:', PyBulletRobot.get_pos_error(desired_cart_pos_3))
    print('now pos 3, orientation get_error:', PyBulletRobot.get_orientation_error(desired_quat_3))
    ...
    PyBulletRobot.set_gripper_width = 0.04
    print('now pos 4, position get_error:', PyBulletRobot.get_pos_error(desired_cart_pos_4))
    print('now pos 4, orientation get_error:', PyBulletRobot.get_orientation_error(desired_quat_4))
    ...
    print('now pos 5, position get_error:', PyBulletRobot.get_pos_error(desired_cart_pos_5))
    print('now pos 5, orientation get_error:', PyBulletRobot.get_orientation_error(desired_quat_5))
    ...
    PyBulletRobot.set_gripper_width = 0.0
    print('now pos 6, position get_error:', PyBulletRobot.get_pos_error(desired_cart_pos_6))
    print('now pos 6, orientation get_error:', PyBulletRobot.get_orientation_error(desired_quat_6))
    ...
    PyBulletRobot.set_gripper_width = 0.04
    print('now pos 7, position get_error:', PyBulletRobot.get_pos_error(desired_cart_pos_7))
    print('now pos 7, orientation get_error:', PyBulletRobot.get_orientation_error(desired_quat_7))

    PyBulletRobot.gotoCartPositionAndQuat(desiredPos=init_pos, desiredQuat=init_or, duration=duration)
    print('now pos 8, position get_error:', PyBulletRobot.get_pos_error(init_pos))
    print('now pos 8, orientation get_error:', PyBulletRobot.get_orientation_error(init_or))
