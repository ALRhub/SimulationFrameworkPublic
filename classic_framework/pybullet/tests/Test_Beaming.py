...
if __name__ == '__main__':
    ...
    PyBulletRobot.beam_to_cart_pos_and_quat(desiredPos=desired_cart_pos_1, desiredQuat=desired_quat_1)
    ...
    PyBulletRobot.beam_to_cart_pos_and_quat(desiredPos=desired_cart_pos_3, desiredQuat=desired_quat_3)
    PyBulletRobot.set_gripper_width = 0.0
    print('now pos 3')
    ...
    PyBulletRobot.gotoCartPositionAndQuat(desiredPos=desired_cart_pos_6, desiredQuat=desired_quat_6,
                                          duration=duration)
    PyBulletRobot.set_gripper_width = 0.0
    print('now pos 6')
